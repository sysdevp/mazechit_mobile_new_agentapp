...
const ForPassword = () => {
  ...
  console.log(data, "hxtrixkdtucdcgukot67")
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(`${baseUrl}/forget-password-reset`, null, {
        params: payload,
      });
      ...
      console.error('Error While Fertching forget-password-reset', err);
    } finally {
