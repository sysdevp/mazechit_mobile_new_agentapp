...
const AuctionReport = () => {
  ...
  return (
    <LinearGradient colors={['#061C3F', '#0A5E6A']} style={styles.gradient}>
      <Header title="Auction Report" showBack={true} />
        ...
        {auctions?.length > 0 ? (
          auctions.filter(
            item =>
              ...
              item.chit_value?.toString().includes(search?.toLowerCase()),
          ).map((item, index) => (
            <View key={index} style={styles.card}>
              <View style={styles.row}>
                <Text style={styles.label}>Date:</Text>
                <Text style={styles.value}>{item.auction_date}</Text>
              </View>
              ...
              <View style={styles.row}>
                ...
                <Text style={styles.value}>₹ {item.chit_value}</Text>
              </View>

              <View style={styles.row}>
                <Text style={styles.label}>Bidding Amount:</Text>
                <Text style={styles.value}>₹ {item.bidding_amount}</Text>
              </View>

              <View style={styles.row}>
                <Text style={styles.label}>Prized Amount:</Text>
                <Text style={[styles.value, { color: '#7CF5A6' }]}>
                  ₹ {item.total_release_amount}
                </Text>
              </View>
            </View>
          ))
