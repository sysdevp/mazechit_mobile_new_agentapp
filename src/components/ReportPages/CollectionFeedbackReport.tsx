...
const CollectionFeedbackReport = () => {
  ...
  const fetchCollectionFeedbackReport = async () => {
    ...
    const remark_date = formatDate(startDate);
  ...
  return (
    <LinearGradient colors={['#061C3F', '#0A5E6A']} style={styles.container}>
      <Header title="Collection Feedback Report" showBack />
...
export default CollectionFeedbackReport;
